...
1. Remove OpenCore either from the USB or internal drive
  ...
  * You'll need to mount the drive's EFI partition, and delete the `EFI/OC` and `System` folders
    ...
    * [See here for an example on how to mount](https://laobamac.github.io/OpenCore-Post-Install/universal/oc2hdd.html)
...
If you want to remove the application without reinstalling the OS, navigate to `/Library/Application Support/` and delete the laobamac folder.
