...
class NewMetallibDownloadFrame(wx.Frame):
    """
    ...
    def __init__(self, parent: wx.Frame, title: str, global_constants: constants.Constants,screen_location: tuple = None):
        ...
        """
        logging.info("初始化 METALLIB 下载控件")
    ...
    def _generate_catalog_frame(self) -> None:
        ...
        # 标题：拉取安装器目录
        title_label = wx.StaticText(self, label="正在查找可下载的Metallib", pos=(-1,5))
    ...
    def _display_available_installers(self, event: wx.Event = None, show_full: bool = False) -> None:
        ...
        self.frame_modal = wx.Dialog(self, title="选择Metallib版本", size=(550, 580))

        # 标题
        title_label = wx.StaticText(self.frame_modal, label="选择此Metallib", pos=(-1,-1))
        title_label.SetFont(gui_support.font_factory(19, wx.FONTWEIGHT_BOLD))
        ...
        self.select_button.SetToolTip("下载选定的Metallib")
        ...
        self.copy_button.SetToolTip("复制所选Metallib安装器的下载链接")
    ...
    def _validate_installer(self, chunklist: str) -> None:
        ...
        # 标题：正在校验
        title_label = wx.StaticText(self, label="校验Metallib安装器的哈希值...", pos=(-1,5))
        title_label.SetFont(gui_support.font_factory(19, wx.FONTWEIGHT_BOLD))
        title_label.Centre(wx.HORIZONTAL)
        ...
        # 下载 chunklist 并校验
        chunklist=chunklist
        logging.info("校验Metallib")
        utilities.disable_sleep_while_running()
        
            

        logging.info("Metallib installer validated")
